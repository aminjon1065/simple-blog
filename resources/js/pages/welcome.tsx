                    ...
                    <div className="flex h-screen flex-col justify-between font-sans">
                        <header className="flex items-center justify-between py-10">
                            ...
                            <div className="flex items-center space-x-4 leading-5 sm:space-x-6">
                                ...
                                <div
                                    className="fixed top-0 left-0 z-10 h-full w-full translate-x-full transform bg-white opacity-95 duration-300 ease-in-out dark:bg-gray-950 dark:opacity-[0.98]"
                                    //   :className="{ 'translate-x-full': !showMenu, 'translate-x-0': showMenu }"
                                >
                            ...
                            <div className="divide-y divide-gray-200 dark:divide-gray-700">
                                <div className="space-y-2 pt-6 pb-8 md:space-y-5">
                                    ...
                                    <p className="text-lg leading-7 text-gray-500 dark:text-gray-400">
                                        A blog created with Tailwind HTML Blog
                                        template
                                    </p>
                                </div>
